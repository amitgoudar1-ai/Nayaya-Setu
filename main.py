...
def safe_translate(text_content, target_lang):
    # Only translate if the tool works AND target is not English
...
# Check if Translator is missing and warn user (but don't crash)
if not HAS_TRANSLATOR:
    st.warning("⚠️ Translation tool is missing. Results will show in English for now.")
    st.info("Fix: Check requirements.txt on GitHub.")
